...
const SideBar = () => {
  return (
    <div className="bg-red-300 h-full flex overflow-y-auto">
      <div className="h-full w-full px-3 py-4 overflow-y-auto bg-white dark:bg-[#272d48]">
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <Link href="/recommendation" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ml-3 whitespace-nowrap">Recommendation</span>
            </Link>
         </li>
         <li>
            <Link href="/management" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
         ...
         <li>
            <Link href="/leads" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
      ...
      <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
         <li>
            <Link href="/profile" className="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
         ...
         <li>
            <Link href="/settings" className="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
