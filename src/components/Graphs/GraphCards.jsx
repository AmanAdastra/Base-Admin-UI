...
const GraphCards = () => {
  return (
    <>
      <div className="flex-1 h-[150px] bg-gradient-to-r from-[#664dc9] to-[#664dcb99] m-2 p-[1.5rem] rounded-md">
      ...
      <div className="flex-1 h-[150px] bg-gradient-to-r from-[#1d976c] to-[#2fd38a] m-2 p-[1.5rem] rounded-md">
        <div className=" h-full flex">
          <div className=" h-full w-[50%]">
            <h6 className=" text-white">Total Sales</h6>
